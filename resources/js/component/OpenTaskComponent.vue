                    ...
                    <div class="flex justify-between mb-5">
                        <div class="w-[80%]">
                            <div class="flex gap-2">
                                ...
                                <h2 :class="{'line-through':taskopen.active==1}">{{ taskopen.title }}</h2>
                            </div>

                            <p class="text-sm ml-6 text-justify" :class="{'line-through':taskopen.active==1}">{{
                                    taskopen.body
                                }}</p>
                        </div>
                        <div>
                            <input type="checkbox" class="bg-red-800 w-5 h-5" v-if="taskopen.active==1" checked>
